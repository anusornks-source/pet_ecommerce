...
export default function AdminProductsPage() {
  ...
  const [filterValidationStatus, setFilterValidationStatus] = useState("Approved");
  ...
  const fetchProducts = useCallback(async (p: number) => {
    ...
    setLoading(false);
  }, [search, filterSource, filterActive, filterCategory, filterPetType, filterTag, filterValidationStatus, shopFilter, urlShopId, sort]);
    ...
    <div>
      ...
      <div className="mb-4 space-y-2">
        <div className="flex flex-wrap gap-2">
          ...
          {activeFilterCount > 0 && (
            <button
              onClick={() => { setFilterSource(""); setFilterActive(""); setFilterCategory(""); setFilterPetType(""); setFilterTag(""); setFilterValidationStatus("Approved"); }}
