...
export default function AdvisorPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white flex flex-col">
      {/* Header */}
      <div className="bg-white border-b border-stone-100 shadow-sm sticky top-16 z-10">
      ...
      {/* Input bar */}
      <div className="sticky bottom-0 bg-white border-t border-stone-100 shadow-[0_-4px_12px_rgba(0,0,0,0.05)]">
