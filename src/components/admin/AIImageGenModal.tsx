...
const PROMPT_GROUPS = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "☀️ Filter สีอบอุ่น", prompt: "warm color tone, golden hour feel" },
      { label: "❄️ Filter สีเย็น", prompt: "cool color tone, clean minimal" },
  ...
  },
  {
    ...
    label: "แสง / เงา",
    options: [
      { label: "🌤️ ใส่เงา soft", prompt: "add soft natural shadow, professional product photo" },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "🏷️ ป้าย SALE", prompt: "add SALE or discount badge, promotional" },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "🖼️ ใส่กรอบ", prompt: "add subtle border or frame around image" },
